...
const SAMPLE_PLACES = [
  ...
  { name: 'The Benjamin Satchwell', category: 'pub', lng: -1.5361677461250125, lat: 52.2897123812359, communityRatings: [], googleRating: 4.1, googleReviewCount: 2345, description: 'JD Wetherspoon pub offering great value food and drink with up to 6 rotating guest ales.' },
    ...
    (position) => {
      ...
      const watchId = navigator.geolocation.watchPosition(
        (position) => {
          ...
          console.log('📍 Position updated:', newLat, newLng);
